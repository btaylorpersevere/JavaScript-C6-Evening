...
// ​
// const sumArray = arr => { //arrow function is a function without a name and without the keyword function, the arrow functio is stored in a variable and is called by that variable's name
//   let sum = 0
...
// const sumArray = n => { //arrow function
//     let sum = 0
...
// const numbers = [1, 2,3]
// function sumArray(n) { //declaration function
//     let sum = 0
//     (for let i = 0; i < arr.length; i++) {
//         return sum += i
//     }
